...
public class BlurTransformation implements Transformation {
    ...
    public Bitmap transform(Bitmap source) {
        ...
        if (false && Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN_MR1) {
            result = renderscriptBlur(mContextReference.get(), source, BLUR_RADIUS);
        } else {
            result = stackBlur(source, BLUR_RADIUS);
            source.recycle();
        }
        return result;
    }
    ...
    /**
     * Thanks to: http://stackoverflow.com/questions/14988990/android-fast-bitmap-blur
     * @param context
     * @param bitmap
     * @param blurRadius
     * @return
    ...
    public static Bitmap renderscriptBlur(Context context, Bitmap bitmap, float blurRadius) {
    ...
    /**
     * Thanks to http://stackoverflow.com/questions/2067955/fast-bitmap-blur-for-android-sdk
     *
     * @param sentBitmap
     * @param radius
     * @return
